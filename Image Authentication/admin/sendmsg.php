	...
	<div class="mainContent1">
		<div class="content">
			<article class="topcontent1">
				...
				<content>
					<p>
					<form name="s" action="msg.php" method="POST" onsubmit="return valid()">
						<table align="center" cellpadding="" cellspacing="" width="">
							...
							<tr>
								<td>
									<font face="Courier New" size="+1"><strong>User EmailId</strong></font>
								</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="a1" id="a1"></td>
							</tr>
							<tr>
								<td>
									<font face="Courier New" size="+1"><strong>User Name</strong></font>
								</td>
								<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="a2" id="a2"></td>
							</tr>
							<tr>
								<td>
									<font face="Courier New" size="+1"><strong>Message</strong></font>
								</td>
